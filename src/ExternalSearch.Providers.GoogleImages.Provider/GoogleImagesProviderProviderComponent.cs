...
namespace CluedIn.Provider.ExternalSearch.GoogleImages
{
    ...
    public sealed class GoogleImagesProviderProviderComponent : ServiceApplicationComponent<IServer>
    {
        ...
        public GoogleImagesProviderProviderComponent(ComponentInfo componentInfo) : base(componentInfo)
        {
            ...
            Container.Register(Component.For<GoogleImagesProviderProviderComponent>().Instance(this));
        }
        ...
        {
            var asm = Assembly.GetAssembly(typeof(GoogleImagesProviderProviderComponent));
